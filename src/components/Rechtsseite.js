...
export function Rechtsseite({ titel, stand, kinder }) {
  return (
    <div className="arbeit" style={{ background: D.hellGrund, color: D.hellText, fontFamily: '"InterTight",system-ui,sans-serif', minHeight: '100vh' }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: BASIS_CSS + `
        ...
        .rtext h2{font-family:'InterTight',sans-serif;font-weight:800;font-size:20px;letter-spacing:-.02em;color:${D.dunkel};margin:32px 0 10px}
